...
Most of the changes I made in this exercise focused on the RobotData object, as this was where I was storing data even
between subsequent pollRuns. So I created a new EfficientRobotData class.

As requested I removed the Coordinate information for each junction. This allowed me to change the data structure I was
using to store junctions. Whereas previously I was using a HashMap, this exercise uses a Stack implemented using the
ArrayList class in java.util . I also considered other implementations like LinkedList, ArrayDeque etc, but I found by
research that ArrayList tends to take less memory than the other implementations which was the goal of this Exercise.

To this end, I also removed my previous Junction class, as it became a useless wrapper for just the heading when we rid
it of being a subclass of Point.
